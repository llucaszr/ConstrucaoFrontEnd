export default function FaltasTable2025() {
  return (
      ...
      <table className="w-full">
        ...
        <tbody>
          <tr className="hover:bg-gray-50 border-b border-gray-200">
            ...
            <td className="p-3 text-center text-gray-800">27</td>
            <td className="p-3 text-center text-gray-800">87.5%</td>
          </tr>
          <tr className="hover:bg-gray-50">
            <td className="p-3 text-gray-800">BI e Data Warehousing</td>
            <td className="p-3 text-center text-gray-800">5</td>
            <td className="p-3 text-center text-gray-800">95%</td>
          </tr>
        </tbody>
      </table>
    </section>
